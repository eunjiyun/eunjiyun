...
반갑습니다! 화면에 무언가를 그려내는 일을 사랑하는 **그래픽스 · 게임 개발자 윤은지**입니다.

- 🖥️ 현재 **3D Viewer 개발자**로 재직 중입니다.
- 🎮 그래픽스와 게임 개발을 공부하고 있어요.
- 🌱 새로운 기술 앞에서는 늘 *"일단 배워보자"* 는 자세로 임합니다.
- 🔍 렌더링 파이프라인부터 인터랙티브한 3D 경험까지, 깊이 파고드는 걸 좋아합니다.
...
![DirectX](https://img.shields.io/badge/DirectX_11%2F12-107C10?style=for-the-badge&logo=microsoft&logoColor=white)
![VTK](https://img.shields.io/badge/VTK-1E5C97?style=for-the-badge&logoColor=white)
